...
const Contact = () => {
  ...
  const teamMembers = [
    { name: "Oleksandr Lanskiy", email: "oleksandr.lanskiy@knf.stud.vu.lt" },
    { name: "Vladyslav Nester", email: "vladyslav.nester@knf.stud.vu.lt" },
    { name: "Arsenia Bohdanova", email: "arsenia.bohdanova@knf.stud.vu.lt" },
    { name: "Yulia Lutsenko", email: "yulia.lutsenko@knf.stud.vu.lt" },
    { name: "Kseniia Klimenko", email: "kseniia.klimenko@knf.stud.vu.lt" },
    { name: "Kyrylo Kolesnichenko", email: "kyrylo.kolesnichenko@knf.stud.vu.lt" },
  ];

  return (
      <div
          style={{
            background: "linear-gradient(135deg, #6ab0de, #805ea6)",
            minHeight: "100vh",
            padding: "20px",
          }}
      >
