    ...
    <div className="relative min-h-screen bg-gray-100">
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center h-full">
          ...
          />
          <h1 className="text-5xl font-extrabold tracking-wide mb-6">{typedText || "..."}</h1>
          <p className="text-lg max-w-3xl mx-auto mb-8 text-gray-200">
            Use <span className="font-bold text-white">ULetter</span> to rewrite letters in
            various styles, generate new ones with specific topics, or get feedback on your drafts
            to improve them.
          </p>
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Feature 3 */}
            <div className="bg-white shadow-lg rounded-lg p-6 transform transition hover:scale-105">
              <h3 className="text-xl font-bold text-gray-700">Adoption OF Writing Style</h3>
              <p className="text-gray-600 mt-2">
